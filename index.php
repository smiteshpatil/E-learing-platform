...
<html lang="en">
  <head>
    <title>Dbatu Learning Platform</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php"><img src="images/BATU_logo.png" alt="BATU logo" height="70"  > Dbatu Learning</a></div>
        ...
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="d-flex align-items-center custom-icon-wrap">
              ...
              <div><h3 class="m-0">100+ Affiliated Colleges</h3></div>
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center" style="height:50vh" >
          <div class="col-md-8 text-center testimony">
            ...
            <h3 class="mb-4">Vedant Hiwarkar</h3>
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about Dbatu Learning, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
            ...
            if(filter_has_var(INPUT_POST, 'submit')){
              ...
              if(!empty($email) && !empty($name) && !empty($message) && !empty($subject)){
                ...
                if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
                  ...
                  // Passed
                  $toEmail = 'support@DbatuLearning.com';
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about Dbatu Learning.</p>
